...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-4">
                <br><br>
                <p class="text-white"><?php $pikachu->attackPokemon($charmeleon, $pikachu->attacks['Electric Ring']); ?>
                </p>
    ...
    <?php
        ...
        // $pikachu->attackPokemon($charmeleon, $pikachu->attacks['Electric Ring']);
        // var_dump($pikachu->attacks['Electric Ring']);
    ?>
</body>
